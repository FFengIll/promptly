...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiGlobalModelsGet: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/global/models`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiGlobalModelsGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ModelSetting>>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).apiGlobalModelsGet(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async apiPromptNamePut(body: UpdatePromptBody, name: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Prompt>>> {
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiGlobalModelsGet(options?: AxiosRequestConfig): Promise<AxiosResponse<ModelSetting>> {
            return DefaultApiFp(configuration).apiGlobalModelsGet(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Ping
         ...
         * @throws {RequiredError}
         */
        async apiPromptNamePut(body: UpdatePromptBody, name: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Prompt>> {
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public async apiGlobalModelsGet(options?: AxiosRequestConfig) : Promise<AxiosResponse<ModelSetting>> {
        return DefaultApiFp(this.configuration).apiGlobalModelsGet(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Ping
     ...
     * @memberof DefaultApi
     */
    public async apiPromptNamePut(body: UpdatePromptBody, name: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Prompt>> {
